...
export function AllCategoriesSection({ routes }: AllCategoriesSectionProps) {
  return (
    <section
      id="all-categories"
      className="mx-auto max-w-6xl px-4 sm:px-6 py-16 border-b border-slate-200"
    >
      <div className="text-left sm:text-center">
        ...
        <p className="max-w-2xl sm:mx-auto mb-10 text-slate-700 text-base sm:text-lg">
          Explore every existing quiz category. The first row is prioritized because it matches the strongest search
          intent.
        </p>
      </div>
