...
export function QuizQuestions({
  ...
  const perfectCountKey = `financequizzes:${typeof document !== "undefined" && document.title ? document.title : quizTitle}:perfectCount`;
  const [storedPerfectCount, setStoredPerfectCount] = useState<number>(perfectCount);
  ...
  async function handleShare() {
    ...
    const buildShareImage = async (): Promise<Blob> => {
      ...
      ctx.fillText(typeof document !== "undefined" && document.title ? document.title : quizTitle, left, y);
