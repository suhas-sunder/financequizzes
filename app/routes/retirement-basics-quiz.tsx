...
export function meta({ data }: Route.MetaArgs) {
  const title = "Retirement Basics Quiz | FinanceQuizzes.com";
  const description =
    "A fast 10-question retirement basics quiz focused on purpose, time horizons, and high-level planning concepts. Timeless and non-instructional, with no rules or limits.";
  const url = data?.canonicalUrl ?? "https://www.financequizzes.com/retirement-basics-quiz";
