...
import { buildCanonicalUrl, getSiteUrlFromEnv } from "../client/components/economics-quiz/seoCanonical.server";
import type { Route } from "./+types/economics-quiz";
import { useLoaderData } from "react-router";
import { useEffect, useMemo, useRef, useState } from "react";

import {
  ECONOMICS_QUIZ_QUESTION_BANK,
  ECONOMICS_FAQS,
  type QuizQuestion,
} from "../client/components/economics-quiz/economicsQuizData";

import { Breadcrumbs } from "../client/components/economics-quiz/Breadcrumbs";
import { QuizQuestions } from "../client/components/economics-quiz/QuizQuestions";
import { EconomicsArticle } from "../client/components/economics-quiz/EconomicsArticle";
import { FAQSection } from "../client/components/economics-quiz/FAQSection";
import { EconomicsQuizJsonLd } from "../client/components/economics-quiz/EconomicsQuizJsonLd";
...
const PERFECT_COUNT_STORAGE_KEY = "financequizzes:perfectCount:/economics-quiz";
const BEST_TIME_STORAGE_KEY = "financequizzes:bestTimeMs:/economics-quiz";
...
export default function FinanceQuiz({}: Route.ComponentProps) {
  ...
  const questionBank = ECONOMICS_QUIZ_QUESTION_BANK;
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Economics Quiz" />
          ...
          >
            <header className="mb-2">
              ...
              <p className="mt-2 text-center text-sm sm:text-base text-slate-600">
                A quick 10-question quiz on core economic concepts: supply and demand,
                inflation, GDP, unemployment, and market structures.
              </p>
            </header>
      ...
      <EconomicsQuizJsonLd faqs={faqs} pageUrl={pageUrl} />
    </main>
  );
}
