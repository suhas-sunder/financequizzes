...
import { buildCanonicalUrl, getSiteUrlFromEnv } from "../client/components/insurance-basics-quiz/seoCanonical.server";
import type { Route } from "./+types/insurance-basics-quiz";
import { useLoaderData } from "react-router";
import { useEffect, useMemo, useRef, useState } from "react";

import {
  INSURANCE_BASICS_QUIZ_QUESTION_BANK,
  INSURANCE_BASICS_FAQS,
  type QuizQuestion,
} from "../client/components/insurance-basics-quiz/insuranceBasicsQuizData";

import { Breadcrumbs } from "../client/components/insurance-basics-quiz/Breadcrumbs";
import { QuizQuestions } from "../client/components/insurance-basics-quiz/QuizQuestions";
import { InsuranceBasicsArticle } from "../client/components/insurance-basics-quiz/InsuranceBasicsArticle";
import { FAQSection } from "../client/components/insurance-basics-quiz/FAQSection";
import { InsuranceBasicsQuizJsonLd } from "../client/components/insurance-basics-quiz/InsuranceBasicsQuizJsonLd";
...
const PERFECT_COUNT_STORAGE_KEY = "financequizzes:perfectCount:/insurance-basics-quiz";
const BEST_TIME_STORAGE_KEY = "financequizzes:bestTimeMs:/insurance-basics-quiz";
...
export default function FinanceQuiz({}: Route.ComponentProps) {
  ...
  const questionBank = INSURANCE_BASICS_QUIZ_QUESTION_BANK;
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Insurance Basics Quiz" />
          ...
          >
            <header className="mb-2">
              ...
              <p className="mt-2 text-center text-sm sm:text-base text-slate-600">
                A quick 10-question quiz on insurance concepts: premiums, deductibles,
                coverage, exclusions, and claims.
              </p>
            </header>
      ...
      <InsuranceBasicsArticle />

      <FAQSection faqs={faqs} />

      <InsuranceBasicsQuizJsonLd faqs={faqs} pageUrl={pageUrl} />
    </main>
  );
}
