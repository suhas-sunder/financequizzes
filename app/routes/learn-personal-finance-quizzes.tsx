...
import type { Route } from "./+types/learn-personal-finance-quizzes";
...
import {
  ...
  type QuizQuestion,
} from "../client/components/learn-personal-finance-quizzes/learnPersonalFinanceQuizData";

import { Breadcrumbs } from "../client/components/learn-personal-finance-quizzes/Breadcrumbs";
import { DailyStats } from "../client/components/learn-personal-finance-quizzes/DailyStats";
import { QuizQuestions } from "../client/components/learn-personal-finance-quizzes/QuizQuestions";
import { PersonalFinanceArticle } from "../client/components/learn-personal-finance-quizzes/PersonalFinanceArticle";
import { FaqAndQuizAnswers } from "../client/components/learn-personal-finance-quizzes/FaqAndQuizAnswers";
import { LearnPersonalFinanceJsonLd } from "../client/components/learn-personal-finance-quizzes/LearnPersonalFinanceJsonLd";
...
const STORAGE_KEY = "personalFinanceQuizStats";
...
export default function PersonalFinanceQuiz({}: Route.ComponentProps) {
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Learn Personal Finance Quizzes" />
      ...
      <LearnPersonalFinanceJsonLd faqs={faqs} questionBank={questionBank} />
    </main>
  );
}
