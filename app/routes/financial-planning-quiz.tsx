...
export function meta({ data }: Route.MetaArgs) {
  const title =
    "Financial Planning Quiz (10 Questions) | FinanceQuizzes.com";

  const description =
    "Test your financial planning fundamentals in under 3 minutes. A free 10-question quiz on goals, priorities, time horizons, and real-world tradeoffs.";
  ...
  const ogImage =
    data?.ogImageUrl ??
    "https://www.financequizzes.com/og/financial-planning-quiz.png";
  ...
  return [
    ...
    { property: "og:image:alt", content: "Financial Planning Quiz with 10 Questions" },
    ...
    { name: "twitter:image:alt", content: "Financial Planning Quiz with 10 Questions" },
