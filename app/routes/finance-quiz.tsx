...
import {
  FINANCE_QUIZ_QUESTION_BANK,
  FINANCE_FAQS,
  type QuizQuestion,
} from "../client/components/finance-quiz/financeQuizData";

import { Breadcrumbs } from "../client/components/finance-quiz/Breadcrumbs";
import { QuizQuestions } from "../client/components/finance-quiz/QuizQuestions";
import { FinanceArticle } from "../client/components/finance-quiz/FinanceArticle";
import { FAQSection } from "../client/components/finance-quiz/FAQSection";
import { FinanceQuizJsonLd } from "../client/components/finance-quiz/FinanceQuizJsonLd";
...
export default function FinanceQuiz({}: Route.ComponentProps) {
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Finance Quiz" />
          ...
          >
            <header className="mb-2">
              ...
              <p className="mt-2 text-center text-sm sm:text-base text-slate-600">
                A quick 10-question challenge across money, banking, credit, and
                investing.
              </p>
            </header>
      ...
      <FinanceQuizJsonLd faqs={faqs} pageUrl={pageUrl} />
    </main>
  );
}
