...
export default function EconomicsQuiz({}: Route.ComponentProps) {
  ...
  const handleAnswer = (
    ...
    // ✅ Preserve all existing stats fields
    setStats((prev) => ({
      ...prev,
    ...
    // ✅ Update streak once 3 questions are answered
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: "https://www.financequizzes.com/learn-economics-quizzes",
              },
            ],
          }),
        }}
