...
export const meta: Route.MetaFunction = () => {
  const canonical = "https://financequizzes.com/cookies";

  const title = "Cookies Policy | FinanceQuizzes";
  const description =
    "Read the FinanceQuizzes cookies policy. Learn how cookies and similar technologies are used on the FinanceQuizzes website.";

  const ogImage = "https://financequizzes.com/og/ilovesvg-cookies.jpg";
  ...
  return [
    ...
    { property: "og:image:alt", content: "FinanceQuizzes cookies policy" },
        ...
        <div className="max-w-[1180px] mx-auto px-4 pt-6 pb-12">
          ...
          <header className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm">
            ...
            <div className="mt-5 space-y-4 text-slate-700 leading-relaxed">
              <p>
                This Cookie Policy explains how FinanceQuizzes ("Company", "we",
                "us", and "our") uses cookies and similar technologies to
                recognize you when you visit our website at
                https://financequizzes.com ("Website"). It explains what these
            ...
            <div className="prose prose-slate max-w-none">
              <Section title="What are cookies?">
                ...
                <p>
                  ...
                  https://financequizzes.com) are called "first-party cookies."
              ...
              <Section title="Where can I get further information?">
                <p>
                  ...
                  technologies, please contact us at support@financequizzes.com.
                </p>
              </Section>
            </div>
          </article>
