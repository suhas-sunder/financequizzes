...
import type { Route } from "./+types/learn-banking-quizzes";
import { useLoaderData } from "react-router";
import { useEffect, useMemo, useState } from "react";

import {
  BANKING_QUIZ_QUESTION_BANK,
  DEFAULT_FAQS,
  type QuizQuestion,
} from "../client/components/learn-banking-quizzes/learnBankingQuizData";

import { Breadcrumbs } from "../client/components/learn-banking-quizzes/Breadcrumbs";
import { DailyStats } from "../client/components/learn-banking-quizzes/DailyStats";
import { QuizQuestions } from "../client/components/learn-banking-quizzes/QuizQuestions";
import { BankingArticle } from "../client/components/learn-banking-quizzes/BankingArticle";
import { FaqAndQuizAnswers } from "../client/components/learn-banking-quizzes/FaqAndQuizAnswers";
import { LearnBankingJsonLd } from "../client/components/learn-banking-quizzes/LearnBankingJsonLd";
...
const STORAGE_KEY = "bankingQuizStats";
...
export default function BankingQuiz({}: Route.ComponentProps) {
  ...
  const questionBank = BANKING_QUIZ_QUESTION_BANK;
    ...
    try {
      ...
      if (parsed.lastDate !== today) {
        setStats({
          ...
          todayCorrect: 0,
          todayStreak: 0,
          // keep best across days (same behavior as original)
  ...
  const pageUrl = "https://www.financequizzes.com/learn-banking-quizzes";
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Learn Banking Quizzes" />
