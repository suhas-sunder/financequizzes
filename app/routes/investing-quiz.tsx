...
import {
  buildCanonicalUrl,
  getSiteUrlFromEnv,
} from "../client/components/investing-quiz/seoCanonical.server";
import type { Route } from "./+types/investing-quiz";
...
import {
  ...
  INVESTING_FAQS,
  type QuizQuestion,
} from "../client/components/investing-quiz/investingQuizData";

import { Breadcrumbs } from "../client/components/investing-quiz/Breadcrumbs";
import { QuizQuestions } from "../client/components/investing-quiz/QuizQuestions";
import { InvestingArticle } from "../client/components/investing-quiz/InvestingArticle";
import { FAQSection } from "../client/components/investing-quiz/FAQSection";
import { InvestingQuizJsonLd } from "../client/components/investing-quiz/InvestingQuizJsonLd";
...
const PERFECT_COUNT_STORAGE_KEY = "financequizzes:perfectCount:/investing-quiz";
const BEST_TIME_STORAGE_KEY = "financequizzes:bestTimeMs:/investing-quiz";
...
export default function FinanceQuiz({}: Route.ComponentProps) {
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Investing Quiz" />
          ...
          >
            <header className="mb-2">
              ...
              <p className="mt-2 text-center text-sm sm:text-base text-slate-600">
                A 10-question challenge covering core investing concepts like
                risk, diversification, time horizon, uncertainty, and market
                behavior.
              </p>
            </header>
      ...
      <InvestingQuizJsonLd faqs={faqs} pageUrl={pageUrl} />
    </main>
  );
}
