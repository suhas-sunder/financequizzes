...
import type { Route } from "./+types/learn-business-quizzes";
import { useLoaderData } from "react-router";
import { useEffect, useMemo, useState } from "react";

import {
  BUSINESS_QUIZ_QUESTION_BANK,
  DEFAULT_FAQS,
  type QuizQuestion,
} from "../client/components/learn-business-quizzes/learnBusinessQuizData";

import { Breadcrumbs } from "../client/components/learn-business-quizzes/Breadcrumbs";
import { DailyStats } from "../client/components/learn-business-quizzes/DailyStats";
import { QuizQuestions } from "../client/components/learn-business-quizzes/QuizQuestions";
import { BusinessArticle } from "../client/components/learn-business-quizzes/BusinessArticle";
import { FaqAndQuizAnswers } from "../client/components/learn-business-quizzes/FaqAndQuizAnswers";
import { LearnBusinessJsonLd } from "../client/components/learn-business-quizzes/LearnBusinessJsonLd";
...
const STORAGE_KEY = "businessQuizStats";
...
export default function BusinessQuiz({}: Route.ComponentProps) {
  ...
  const questionBank = BUSINESS_QUIZ_QUESTION_BANK;
  ...
  const pageUrl = "https://www.financequizzes.com/learn-business-quizzes";
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Learn Business Quizzes" />
