...
export const meta: Route.MetaFunction = () => {
  const canonical = "https://financequizzes.com/privacy-policy";

  const title = "Privacy Policy | FinanceQuizzes";
  const description =
    "Read the FinanceQuizzes privacy policy. Learn how data is handled and protected when you use FinanceQuizzes quizzes and pages.";

  const ogImage = "https://financequizzes.com/og/ilovesvg-privacy.jpg";
  ...
  return [
    ...
    { property: "og:image:alt", content: "FinanceQuizzes privacy policy" },
        ...
        <div className="max-w-[1180px] mx-auto px-4 pt-6 pb-12">
          ...
          <header className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm">
            ...
            <div className="mt-5 space-y-4 text-slate-700 leading-relaxed">
              <p>
                <span>
                  This privacy notice for FinanceQuizzes (https://financequizzes.com)
                ...
                <ul className="mt-4 list-inside list-disc flex flex-col gap-2 pl-5">
                  <li>
                    Visit our website at https://financequizzes.com, or any
              ...
              <p className="space-y-1">
                <span className="block">
                  Data controller: FinanceQuizzes is responsible for deciding how your
                  personal information is processed for the purposes described
                  in this privacy notice.
                </span>
                <span className="block">
                  Contact: support@financequizzes.com (Toronto, Ontario, Canada).
                </span>
              </p>
            </div>
          </header>
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <Section title="1. WHAT INFORMATION DO WE COLLECT?">
                ...
                <p>
                  ...
                  this in our Cookie Notice: https://financequizzes.com/cookies.
                </p>
              ...
              <Section title="6. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?">
                ...
                <p>
                  ...
                  https://financequizzes.com/cookies.
                </p>
                <p>
              ...
              <Section title="8. DO WE COLLECT INFORMATION FROM MINORS?">
                ...
                <p>
                  ...
                  us at support@financequizzes.com and we will take appropriate steps to
              ...
              <Section title="9. WHAT ARE YOUR PRIVACY RIGHTS?">
                ...
                <p>
                  ...
                  personal information by contacting us at support@financequizzes.com.
              ...
              <Section title="11. CONTACT US">
                <p>
                  ...
                  email us at support@financequizzes.com or contact us by post at:
                </p>
                <p>https://financequizzes.com/</p>
                <p>Toronto, Ontario</p>
                <p>Canada</p>
              </Section>
            </div>
  ...
  return (
    <footer className="bg-white border-t border-slate-200">
      <div className="max-w-[1180px] mx-auto px-4 py-6 text-sm text-slate-600 flex items-center justify-between">
        <span>© {new Date().getFullYear()} FinanceQuizzes</span>
