...
import {
  buildCanonicalUrl,
  getSiteUrlFromEnv,
} from "../client/components/banking-and-credit/seoCanonical.server";
import type { Route } from "./+types/banking-and-credit-quiz";
import { useLoaderData } from "react-router";
import { useEffect, useMemo, useRef, useState } from "react";

import {
  BANKING_AND_CREDIT_QUIZ_QUESTION_BANK,
  BANKING_AND_CREDIT_FAQS,
  type QuizQuestion,
} from "../client/components/banking-and-credit/bankingAndCreditQuizData";

import { Breadcrumbs } from "../client/components/banking-and-credit/Breadcrumbs";
import { QuizQuestions } from "../client/components/banking-and-credit/QuizQuestions";
import { BankingAndCreditArticle } from "../client/components/banking-and-credit/BankingAndCreditArticle";
import { FAQSection } from "../client/components/banking-and-credit/FAQSection";
import { BankingAndCreditQuizJsonLd } from "../client/components/banking-and-credit/BankingAndCreditQuizJsonLd";
...
const PERFECT_COUNT_STORAGE_KEY =
  "financequizzes:perfectCount:/banking-and-credit";
const BEST_TIME_STORAGE_KEY = "financequizzes:bestTimeMs:/banking-and-credit";
...
export default function FinanceQuiz({}: Route.ComponentProps) {
  ...
  const questionBank = BANKING_AND_CREDIT_QUIZ_QUESTION_BANK;
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Banking and Credit Quiz" />
          ...
          >
            <header className="mb-2">
              ...
              <p className="mt-2 text-center text-sm sm:text-base text-slate-600">
                A quick 10-question quiz on everyday banking and credit terms:
                accounts, balances, statements, fees, and obligations.
              </p>
            </header>
      ...
      <BankingAndCreditArticle />

      <FAQSection faqs={faqs} />

      <BankingAndCreditQuizJsonLd faqs={faqs} pageUrl={pageUrl} />
    </main>
  );
}
