...
import {
  buildCanonicalUrl,
  getSiteUrlFromEnv,
} from "../client/components/stock-market-basics-quiz/seoCanonical.server";
import type { Route } from "./+types/stock-market-basics-quiz";
import { useLoaderData } from "react-router";
import { useEffect, useMemo, useRef, useState } from "react";

import {
  STOCK_MARKET_BASICS_QUIZ_QUESTION_BANK,
  STOCK_MARKET_BASICS_FAQS,
  type QuizQuestion,
} from "../client/components/stock-market-basics-quiz/stockMarketBasicsQuizData";

import { Breadcrumbs } from "../client/components/stock-market-basics-quiz/Breadcrumbs";
import { QuizQuestions } from "../client/components/stock-market-basics-quiz/QuizQuestions";
import { StockMarketBasicsArticle } from "../client/components/stock-market-basics-quiz/StockMarketBasicsArticle";
import { FAQSection } from "../client/components/stock-market-basics-quiz/FAQSection";
import { StockMarketBasicsQuizJsonLd } from "../client/components/stock-market-basics-quiz/StockMarketBasicsQuizJsonLd";
...
const PERFECT_COUNT_STORAGE_KEY =
  "financequizzes:perfectCount:/stock-market-basics-quiz";
const BEST_TIME_STORAGE_KEY =
  "financequizzes:bestTimeMs:/stock-market-basics-quiz";
...
export default function FinanceQuiz({}: Route.ComponentProps) {
  ...
  const questionBank = STOCK_MARKET_BASICS_QUIZ_QUESTION_BANK;
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Stock Market Basics Quiz" />
          ...
          >
            <header className="mb-2">
              ...
              <p className="mt-2 text-center text-sm sm:text-base text-slate-600">
                A 10-question quiz on how stock markets work, what stocks
                represent, and how market terms are defined.
              </p>
            </header>
      ...
      <StockMarketBasicsArticle />

      <FAQSection faqs={faqs} />

      <StockMarketBasicsQuizJsonLd faqs={faqs} pageUrl={pageUrl} />
    </main>
  );
}
