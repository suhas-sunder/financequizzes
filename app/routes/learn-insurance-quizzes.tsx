...
import type { Route } from "./+types/learn-insurance-quizzes";
import { useLoaderData } from "react-router";
import { useEffect, useMemo, useState } from "react";

import {
  DEFAULT_FAQS,
  INSURANCE_QUIZ_QUESTION_BANK,
  type QuizQuestion,
} from "../client/components/learn-insurance-quizzes/learnInsuranceQuizData";

import { Breadcrumbs } from "../client/components/learn-insurance-quizzes/Breadcrumbs";
import { DailyStats } from "../client/components/learn-insurance-quizzes/DailyStats";
import { QuizQuestions } from "../client/components/learn-insurance-quizzes/QuizQuestions";
import { InsuranceArticle } from "../client/components/learn-insurance-quizzes/InsuranceArticle";
import { FaqAndQuizAnswers } from "../client/components/learn-insurance-quizzes/FaqAndQuizAnswers";
import { LearnInsuranceJsonLd } from "../client/components/learn-insurance-quizzes/LearnInsuranceJsonLd";
...
const STORAGE_KEY = "insuranceQuizStats";
...
export default function InsuranceQuiz({}: Route.ComponentProps) {
  ...
  const questionBank = INSURANCE_QUIZ_QUESTION_BANK;
  ...
  return (
    <main className="bg-white text-[#0B1B2B]">
      ...
      >
        <Breadcrumbs currentLabel="Learn Insurance Quizzes" />
      ...
      <LearnInsuranceJsonLd faqs={faqs} questionBank={questionBank} />
    </main>
  );
}
